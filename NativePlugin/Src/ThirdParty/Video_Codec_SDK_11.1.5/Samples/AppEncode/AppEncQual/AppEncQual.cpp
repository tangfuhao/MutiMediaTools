...
void EncQual(char *szInFilePath, char *szOutFilePath, int nWidth, int nHeight, NV_ENC_BUFFER_FORMAT eFormat, int iGpu, NvEncoderInitParam &encodeCLIOptions)
{
    ...
    NvDecoder dec(cuContext, false, encodeCLIOptions.IsCodecH264() ? cudaVideoCodec_H264 : cudaVideoCodec_HEVC);
    ...
    do 
    {
        ...
        nFrameReturned = dec.Decode(vTmpPacket.data(), (int)vTmpPacket.size(), nRead != nSize);
